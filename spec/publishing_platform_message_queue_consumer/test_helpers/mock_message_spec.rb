...
RSpec.describe PublishingPlatformMessageQueueConsumer::MockMessage do # rubocop:disable RSpec/SpecFilePathFormat
  describe "#methods" do
    it "implements the same methods as Message" do
      mock = described_class.new
      real = PublishingPlatformMessageQueueConsumer::Message.new(double, double, double)

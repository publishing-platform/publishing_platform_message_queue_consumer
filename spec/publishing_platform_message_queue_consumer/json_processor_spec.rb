...
RSpec.describe PublishingPlatformMessageQueueConsumer::JSONProcessor do
  describe "#process" do
    it "parses the payload string" do
      message = PublishingPlatformMessageQueueConsumer::MockMessage.new('{"some":"json"}', { content_type: "application/json" })
    ...
    it "doesn't parse non-JSON message" do
      message = PublishingPlatformMessageQueueConsumer::MockMessage.new("<SomeXML></SomeXML>", { content_type: "application/xml" })
